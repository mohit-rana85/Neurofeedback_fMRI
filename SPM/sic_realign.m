function handles= sic_realign(handles)
try
    if handles.b.flag.isrealignment_ref_run
        P{1}(1)=handles.b.pre.ref_file_vol_data_run;
        P{1}(2)=handles.b.current_volume.V;
    else
        P{1}(1)=handles.b.pre.normalization.ref_file_vol_data;
        P{1}(2)=handles.b.current_volume.V;
    end
    
    if length(P)==1,
        P{1} = realign_series(P{1},handles.b.pre.realign_opt);
        %     if nargout==0, save_parameters(P{1}); end;
        handles.b.current_volume.para=save_parameters(P{1});
    ...
    if length(P)==1,
        handles.b.Feedback.realign=P{1};
    end;
