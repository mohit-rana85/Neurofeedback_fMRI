function SPM = spm_contrasts(SPM,Ic,pth)
...
%                         '...computing');                                %-#
                    ...
                    %------------------------------------------------------
                    xCon(ic).Vcon = struct(...
                        'fname',  [pth,filesep,sprintf('con_%04d',ic) file_ext],...
                        'dim',    SPM.xVol.DIM',...
...
%                     '...computing');                                    %-#
                ...
                %----------------------------------------------------------
                xCon(ic).Vcon = struct(...
                    'fname',  [pth,filesep,sprintf('ess_%04d',ic) file_ext],...
                    'dim',    SPM.xVol.DIM',...
                    'dt',     [spm_type('float32'), spm_platform('bigend')],...
                    'mat',    SPM.xVol.M,...
                    'pinfo',  [1,0,0]',...
...
%             '...computing');                                            %-#
        ...
        %------------------------------------------------------------------
        xCon(ic).Vspm = struct(...
            'fname',  [pth,filesep,sprintf('spm%s_%04d',xCon(ic).STAT,ic) file_ext],...
            'dim',    SPM.xVol.DIM',...
            'dt',     [spm_type('float32'), spm_platform('bigend')],...
            'mat',    SPM.xVol.M,...
            'pinfo',  [1,0,0]',...
