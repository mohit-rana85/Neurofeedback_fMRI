function [VO,v]=sic_reslice(P,flags)
...
def_flags = struct('interp',4,'mask',0,'mean',0,'which',2,'wrap',[0 0 0]');
if nargin < 2,
	flags = def_flags;
else,
...
[VO,v]=reslice_images(P,flags);
return;


%==========================================================================
function [VO,v]=reslice_images(P,flags)
...
if flags.mean
    ...
    PO=spm_write_vol(PO,Integral);
%      PO = spm_create_vol(PO);
%       PO = spm_write_plane(PO,Integral,':');
      VO=PO;
